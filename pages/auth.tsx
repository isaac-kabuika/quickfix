  ...
  return (
    <>
      ...
      <main className="container mx-auto mt-16 p-4">
        <div className="max-w-md mx-auto bg-gray-800 rounded-lg shadow-neon p-8">
          <h1 className="text-3xl font-bold mb-6 text-center text-primary-400">Sign In / Sign Up to QuickFix AI</h1>
          ...
          <form onSubmit={(e) => handleEmailSubmit(e, true)} className="space-y-4">
            <input
              ...
              placeholder="Email"
              required
              className="w-full p-3 bg-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500"
            />
            <input
              type="password"
              value={password}
